...
public class MediumPouchContainer extends AbstractContainerMenu {
    private final IItemHandler itemHandler;
    private final ItemStack pouchStack;

    public MediumPouchContainer(int id, Inventory playerInventory, IItemHandler itemHandler, ItemStack pouchStack) {
        super(ModMenuTypes.MEDIUM_POUCH.get(), id);
        ...
        // Slots for medium pouch (2 rows of 9 slots)
    ...
    public MediumPouchContainer(int id, Inventory playerInventory, FriendlyByteBuf extraData) {
    ...
    public MediumPouchContainer(int id, Inventory playerInventory) {
        this(id, playerInventory, PouchItem.getHandler(playerInventory.player.getMainHandItem()), playerInventory.player.getMainHandItem());
    }
